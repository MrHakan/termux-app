...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'HOME','UP','END','PGUP','NEW_SESSION'], ['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN',{key: 'NEXT_SESSION', popup: 'DRAWER'}]]"; // Double row
